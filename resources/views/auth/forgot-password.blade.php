...
<head>
    ...
    <title>Recuperar contraseña · ESAT</title>
        ...
        <main class="login-form-panel">
            <div class="login-form-wrap">
                <div class="login-form-card">
                    ...
                    <a href="{{ route('login') }}" class="login-back" aria-label="Volver a iniciar sesión">
                        <svg viewBox="0 0 24 24"><path d="M19 12H5M11 6l-6 6 6 6"/></svg>
                    </a>

                    <h1>Recuperar contraseña</h1>
                    <p>¿Olvidaste tu contraseña? Escribe tu correo y te enviaremos un enlace para crear una nueva.</p>
