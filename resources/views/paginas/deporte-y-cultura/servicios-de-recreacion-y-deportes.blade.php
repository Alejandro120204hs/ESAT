...
@section('title', 'Servicios de Recreación y Deportes · ESAT — Formación Técnica Certificada')
@section('meta_description', 'Técnico en Servicios de Recreación y Deportes en ESAT: formación en actividades recreativas, deportivas y de integración social para promover hábitos saludables.')
...
@section('content')
        ...
        <section class="program-hero">
            ...
            <div class="section-inner">
                <div class="program-hero-content">
                    ...
                    <h1>Servicios de Recreación y Deportes</h1>
                    <p class="program-hero-tagline">Bienestar y vida activa para todos.</p>
                    <p class="program-hero-lead">Formamos profesionales en actividades recreativas, deportivas y de integración social, promoviendo hábitos saludables, bienestar físico y desarrollo comunitario.</p>
                    <div class="hero-actions">
                        <a href="{{ $wa('Servicios de Recreación y Deportes') }}" target="_blank" rel="noopener" class="btn btn-accent btn-lg">
        ...
        <section class="program-section">
            ...
            <div class="section-inner">
                <div class="section-head" data-aos="fade-up">
                    ...
                    <p>Aprende a liderar, organizar y animar actividades recreativas y deportivas para la comunidad.</p>
                </div>
                <div class="program-competency-grid">
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="0">
                        <span class="node"><svg viewBox="0 0 24 24"><use href="#ico-deporte"/></svg></span>
                        <div><h3>Liderazgo</h3><p>Lidera grupos y actividades recreativas con confianza y motivación.</p></div>
                    </div>
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="80">
                        ...
                        <div><h3>Organización de actividades</h3><p>Organiza actividades recreativas y deportivas para distintos públicos.</p></div>
                    </div>
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="160">
                        ...
                        <div><h3>Animación grupal</h3><p>Anima y dinamiza actividades que fomentan la integración social.</p></div>
                    </div>
            ...
            <div class="section-inner">
                <article class="program-photo-panel" data-aos="fade-up">
                    ...
                    <div class="program-photo-panel-content">
                        ...
                        <p>Practica el liderazgo y la organización de actividades recreativas guiado por un equipo profesional.</p>
                    </div>
                </article>
            </div>
        </section>
        ...
        <section class="program-cta">
            ...
            <div class="section-inner program-cta-inner" data-aos="fade-up">
                <div>
                    <h2>¿Listo para formarte en Servicios de Recreación y Deportes?</h2>
