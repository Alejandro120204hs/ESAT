...
@section('title', 'Salvamento Acuático · ESAT — Formación Técnica Certificada')
@section('meta_description', 'Técnico en Salvamento Acuático en ESAT: formación en rescate, prevención de riesgos y primeros auxilios en entornos acuáticos.')
...
@section('content')
        ...
        <section class="program-hero">
            ...
            <div class="section-inner">
                <div class="program-hero-content">
                    ...
                    <h1>Salvamento Acuático</h1>
                    <p class="program-hero-tagline">Rescate y seguridad en el agua.</p>
                    <p class="program-hero-lead">Formamos profesionales en rescate, prevención de riesgos y primeros auxilios en entornos acuáticos, con competencias físicas y técnicas para actuar con seguridad y eficacia.</p>
                    <div class="hero-actions">
                        <a href="{{ $wa('Salvamento Acuático') }}" target="_blank" rel="noopener" class="btn btn-accent btn-lg">
        ...
        <section class="program-section">
            ...
            <div class="section-inner">
                <div class="section-head" data-aos="fade-up">
                    ...
                    <p>Aprende técnicas de rescate, prevención de riesgos y primeros auxilios en entornos acuáticos.</p>
                </div>
                <div class="program-competency-grid">
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="0">
                        ...
                        <div><h3>Rescate acuático</h3><p>Ejecuta técnicas de rescate seguras en entornos acuáticos.</p></div>
                    </div>
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="80">
                        ...
                        <div><h3>Prevención de riesgos</h3><p>Identifica y previene riesgos en piscinas y espacios acuáticos.</p></div>
                    </div>
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="160">
                        ...
                        <div><h3>Primeros auxilios</h3><p>Brinda atención inmediata ante emergencias en el agua.</p></div>
                    </div>
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="240">
                        ...
                        <div><h3>Condición física y técnica</h3><p>Desarrolla la condición física y técnica que exige el salvamento acuático.</p></div>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="section-inner">
                <article class="program-photo-panel" data-aos="fade-up">
                    ...
                    <div class="program-photo-panel-content">
                        ...
                        <p>Practica técnicas de rescate y primeros auxilios guiado por un equipo profesional.</p>
                    </div>
                </article>
            </div>
        </section>
        ...
        <section class="program-cta">
            ...
            <div class="section-inner program-cta-inner" data-aos="fade-up">
                <div>
                    <h2>¿Listo para formarte en Salvamento Acuático?</h2>
