...
@section('title', 'Inspector de Calidad de Alimentos y Bebidas · ESAT — Formación Técnica Certificada')
@section('meta_description', 'Técnico Inspector de Calidad de Alimentos y Bebidas en ESAT: formación en control, evaluación y cumplimiento normativo para la seguridad alimentaria.')
...
@section('content')
        ...
        <section class="program-hero">
            ...
            <div class="section-inner">
                <div class="program-hero-content">
                    ...
                    <h1>Inspector de Calidad de Alimentos y Bebidas</h1>
                    <p class="program-hero-tagline">Garantía de seguridad y confianza.</p>
                    <p class="program-hero-lead">Formamos profesionales en control, evaluación y cumplimiento normativo, garantizando la seguridad y calidad de alimentos y bebidas.</p>
                    <div class="hero-actions">
                        <a href="{{ $wa('Inspector de Calidad de Alimentos y Bebidas') }}" target="_blank" rel="noopener" class="btn btn-accent btn-lg">
        ...
        <section class="program-section">
            ...
            <div class="section-inner">
                <div class="section-head" data-aos="fade-up">
                    ...
                    <p>Domina los procesos de control de calidad que garantizan alimentos y bebidas seguros.</p>
                </div>
                <div class="program-competency-grid">
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="0">
                        ...
                        <div><h3>Control y evaluación</h3><p>Controla y evalúa la calidad de alimentos y bebidas.</p></div>
                    </div>
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="80">
                        ...
                        <div><h3>Cumplimiento normativo</h3><p>Aplica la normativa vigente en seguridad alimentaria.</p></div>
                    </div>
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="160">
                        ...
                        <div><h3>Seguridad alimentaria</h3><p>Garantiza la inocuidad de los productos que se ofrecen.</p></div>
                    </div>
            ...
            <div class="section-inner">
                <article class="program-photo-panel" data-aos="fade-up">
                    ...
                    <div class="program-photo-panel-content">
                        ...
                        <p>Practica el control de calidad de alimentos guiado por un equipo profesional.</p>
                    </div>
                </article>
            </div>
        </section>
        ...
        <section class="program-cta">
            ...
            <div class="section-inner program-cta-inner" data-aos="fade-up">
                <div>
                    <h2>¿Listo para formarte en Inspector de Calidad de Alimentos y Bebidas?</h2>
