...
@section('title', 'Electricista · ESAT — Formación Técnica Certificada')
@section('meta_description', 'Técnico Electricista en ESAT: formación en instalación, mantenimiento y reparación de sistemas eléctricos residenciales, comerciales e industriales.')

@php
    // Drop the real photo in public/assets/img with this exact
    // filename and it replaces the placeholder panel automatically —
    // no code changes needed.
    $heroPhoto = 'electricista.png';
    $heroPhotoExists = file_exists(public_path('assets/img/' . $heroPhoto));
    $practicePhoto = 'aprender-electricista.png';
    $practicePhotoExists = file_exists(public_path('assets/img/' . $practicePhoto));

    $outcomes = [
        ['Proyectos residenciales', 'Realiza instalaciones eléctricas en proyectos residenciales.', 'ico-building', 'orange', 'proyecto-residencial-electrico.jpeg'],
        ['Entornos comerciales', 'Brinda mantenimiento eléctrico en entornos comerciales.', 'ico-tool', 'green', 'entorno-comercial-electrico.jpeg'],
        ['Entornos industriales', 'Trabaja en el mantenimiento eléctrico de entornos industriales.', 'ico-shield', 'navy', 'entorno-industrial-electrico.jpeg'],
    ];
@endphp
...
@section('content')
        ...
        <section class="program-hero">
            ...
            <div class="section-inner">
                <div class="program-hero-content">
                    ...
                    <h1>Electricista</h1>
                    <p class="program-hero-tagline">Energía segura en cada instalación.</p>
                    <p class="program-hero-lead">Formamos profesionales en instalación, mantenimiento y reparación de sistemas eléctricos, con énfasis en la aplicación práctica y la seguridad en distintos entornos.</p>
                    <div class="hero-actions">
                        <a href="{{ $wa('Electricista') }}" target="_blank" rel="noopener" class="btn btn-accent btn-lg">
        ...
        <section class="program-section">
            ...
            <div class="section-inner">
                <div class="section-head" data-aos="fade-up">
                    ...
                    <p>Aprende a instalar, mantener y reparar sistemas eléctricos con seguridad y eficiencia.</p>
                </div>
                <div class="program-competency-grid">
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="0">
                        ...
                        <div><h3>Instalaciones eléctricas</h3><p>Ejecuta instalaciones eléctricas seguras y funcionales.</p></div>
                    </div>
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="80">
                        ...
                        <div><h3>Mantenimiento eléctrico</h3><p>Realiza mantenimiento preventivo y correctivo de sistemas eléctricos.</p></div>
                    </div>
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="160">
                        ...
                        <div><h3>Reparación de sistemas</h3><p>Diagnostica y repara fallas en sistemas eléctricos.</p></div>
                    </div>
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="240">
                        ...
                        <div><h3>Trabajo seguro</h3><p>Aplica normas de seguridad en cada intervención eléctrica.</p></div>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="section-inner">
                <article class="program-photo-panel" data-aos="fade-up">
                    ...
                    <div class="program-photo-panel-content">
                        ...
                        <p>Practica instalaciones y mantenimiento eléctrico guiado por un equipo profesional.</p>
                    </div>
                </article>
            </div>
        </section>
        ...
        <section class="program-cta">
            ...
            <div class="section-inner program-cta-inner" data-aos="fade-up">
                <div>
                    <h2>¿Listo para formarte en Electricista?</h2>
