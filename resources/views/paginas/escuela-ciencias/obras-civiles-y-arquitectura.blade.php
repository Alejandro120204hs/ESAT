...
@section('title', 'Obras Civiles y Arquitectura · ESAT — Formación Técnica Certificada')
@section('meta_description', 'Técnico en Obras Civiles y Arquitectura en ESAT: formación en apoyo técnico, construcción y supervisión básica de proyectos constructivos.')

@php
    // Drop the real photo in public/assets/img with this exact
    // filename and it replaces the placeholder panel automatically —
    // no code changes needed.
    $heroPhoto = 'obras-civiles.png';
    $heroPhotoExists = file_exists(public_path('assets/img/' . $heroPhoto));
    $practicePhoto = 'aprender-obras-civiles.png';
    $practicePhotoExists = file_exists(public_path('assets/img/' . $practicePhoto));

    $outcomes = [
        ['Empresas constructoras', 'Apoya procesos constructivos en empresas del sector.', 'ico-building', 'orange', 'empresa-constructora.jpeg'],
        ['Estudios de arquitectura', 'Brinda soporte técnico en estudios de arquitectura y diseño.', 'ico-palette', 'green', 'estudio-arquitectura.jpeg'],
        ['Proyectos de infraestructura', 'Participa en proyectos de infraestructura pública o privada.', 'ico-tool', 'navy', 'proyecto-infraestructura.jpeg'],
    ];
@endphp
...
@section('content')
        ...
        <section class="program-hero">
            ...
            <div class="section-inner">
                <div class="program-hero-content">
                    ...
                    <h1>Obras Civiles y Arquitectura</h1>
                    <p class="program-hero-tagline">Construye con precisión y seguridad.</p>
                    <p class="program-hero-lead">Formamos profesionales en apoyo técnico, construcción y supervisión básica de proyectos, desarrollando habilidades prácticas para ejecutar obras seguras y funcionales.</p>
                    <div class="hero-actions">
                        <a href="{{ $wa('Obras Civiles y Arquitectura') }}" target="_blank" rel="noopener" class="btn btn-accent btn-lg">
        ...
        <section class="program-section">
            ...
            <div class="section-inner">
                <div class="section-head" data-aos="fade-up">
                    ...
                    <p>Aprende a ejecutar y supervisar obras civiles seguras y funcionales.</p>
                </div>
                <div class="program-competency-grid">
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="0">
                        ...
                        <div><h3>Apoyo técnico en construcción</h3><p>Brinda apoyo técnico en procesos de construcción.</p></div>
                    </div>
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="80">
                        ...
                        <div><h3>Ejecución de obras</h3><p>Ejecuta obras civiles seguras y funcionales.</p></div>
                    </div>
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="160">
                        ...
                        <div><h3>Supervisión básica de proyectos</h3><p>Apoya la supervisión básica de proyectos constructivos.</p></div>
                    </div>
            ...
            <div class="section-inner">
                <article class="program-photo-panel" data-aos="fade-up">
                    ...
                    <div class="program-photo-panel-content">
                        ...
                        <p>Practica la ejecución y supervisión de obras guiado por un equipo profesional.</p>
                    </div>
                </article>
            </div>
        </section>
        ...
        <section class="program-cta">
            ...
            <div class="section-inner program-cta-inner" data-aos="fade-up">
                <div>
                    <h2>¿Listo para formarte en Obras Civiles y Arquitectura?</h2>
