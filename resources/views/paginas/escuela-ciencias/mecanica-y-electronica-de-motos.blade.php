...
@section('title', 'Mecánica y Electrónica de Motos · ESAT — Formación Técnica Certificada')
@section('meta_description', 'Técnico en Mecánica y Electrónica de Motos en ESAT: formación en diagnóstico, mantenimiento y reparación de sistemas mecánicos y electrónicos de motocicletas.')

@php
    // Drop the real photo in public/assets/img with this exact
    // filename and it replaces the placeholder panel automatically —
    // no code changes needed.
    $heroPhoto = 'mecanica-motos.png';
    $heroPhotoExists = file_exists(public_path('assets/img/' . $heroPhoto));
    $practicePhoto = 'aprender-mecanica-motos.png';
    $practicePhotoExists = file_exists(public_path('assets/img/' . $practicePhoto));

    $outcomes = [
        ['Talleres de motos', 'Diagnostica y repara motocicletas en talleres especializados.', 'ico-tool', 'orange', 'taller-motos.jpeg'],
        ['Concesionarios', 'Brinda mantenimiento y soporte técnico en concesionarios.', 'ico-building', 'green', 'concesionario-motos.jpeg'],
        ['Proyectos de mantenimiento especializado', 'Participa en proyectos de mantenimiento especializado de motos.', 'ico-check', 'navy', 'proyecto-mantenimiento-motos.jpeg'],
    ];
@endphp
...
@section('content')
        ...
        <section class="program-hero">
            ...
            <div class="section-inner">
                <div class="program-hero-content">
                    ...
                    <h1>Mecánica y Electrónica de Motos</h1>
                    <p class="program-hero-tagline">Diagnóstico y reparación con precisión.</p>
                    <p class="program-hero-lead">Formamos profesionales en diagnóstico, mantenimiento y reparación de sistemas mecánicos y electrónicos, fortaleciendo competencias técnicas para el sector de las motocicletas.</p>
                    <div class="hero-actions">
                        <a href="{{ $wa('Mecánica y Electrónica de Motos') }}" target="_blank" rel="noopener" class="btn btn-accent btn-lg">
        ...
        <section class="program-section">
            ...
            <div class="section-inner">
                <div class="section-head" data-aos="fade-up">
                    ...
                    <p>Aprende a diagnosticar, mantener y reparar sistemas mecánicos y electrónicos de motocicletas.</p>
                </div>
                <div class="program-competency-grid">
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="0">
                        ...
                        <div><h3>Diagnóstico de motos</h3><p>Diagnostica fallas en sistemas mecánicos y electrónicos.</p></div>
                    </div>
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="80">
                        ...
                        <div><h3>Mantenimiento</h3><p>Realiza mantenimiento preventivo de motocicletas.</p></div>
                    </div>
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="160">
                        ...
                        <div><h3>Reparación</h3><p>Repara sistemas mecánicos y electrónicos con precisión.</p></div>
                    </div>
            ...
            <div class="section-inner">
                <article class="program-photo-panel" data-aos="fade-up">
                    ...
                    <div class="program-photo-panel-content">
                        ...
                        <p>Practica el diagnóstico y la reparación de motocicletas guiado por un equipo profesional.</p>
                    </div>
                </article>
            </div>
        </section>
        ...
        <section class="program-cta">
            ...
            <div class="section-inner program-cta-inner" data-aos="fade-up">
                <div>
                    <h2>¿Listo para formarte en Mecánica y Electrónica de Motos?</h2>
