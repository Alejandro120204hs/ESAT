...
@section('title', 'Criminalística, Investigación Judicial y Ciencias Forenses · ESAT — Formación Técnica Certificada')
@section('meta_description', 'Técnico en Criminalística, Investigación Judicial y Ciencias Forenses en ESAT: formación en análisis de evidencia, procedimientos investigativos y apoyo técnico forense.')

@php
    // Drop the real photo in public/assets/img with this exact
    // filename and it replaces the placeholder panel automatically —
    // no code changes needed.
    $heroPhoto = 'criminalistica.png';
    $heroPhotoExists = file_exists(public_path('assets/img/' . $heroPhoto));
    $practicePhoto = 'aprender-criminalistica.png';
    $practicePhotoExists = file_exists(public_path('assets/img/' . $practicePhoto));

    $outcomes = [
        ['Entidades judiciales', 'Apoya procesos dentro de entidades del sistema judicial.', 'ico-scale', 'orange', 'entidad-judicial.jpeg'],
        ['Laboratorios forenses', 'Participa en el análisis técnico dentro de laboratorios forenses.', 'ico-shield', 'green', 'laboratorio-forense.jpeg'],
        ['Organismos de investigación', 'Trabaja en organismos dedicados a la investigación criminal.', 'ico-check', 'navy', 'organismo-investigacion.jpeg'],
    ];
@endphp
...
@section('content')
        ...
        <section class="program-hero">
            ...
            <div class="section-inner">
                <div class="program-hero-content">
                    ...
                    <h1>Criminalística, Investigación Judicial y Ciencias Forenses</h1>
                    <p class="program-hero-tagline">La verdad, a través de la evidencia.</p>
                    <p class="program-hero-lead">Formamos profesionales en análisis de evidencia, procedimientos investigativos y apoyo técnico, fortaleciendo competencias para el esclarecimiento de los hechos.</p>
                    <div class="hero-actions">
                        <a href="{{ $wa('Criminalística, Investigación Judicial y Ciencias Forenses') }}" target="_blank" rel="noopener" class="btn btn-accent btn-lg">
        ...
        <section class="program-section">
            ...
            <div class="section-inner">
                <div class="section-head" data-aos="fade-up">
                    ...
                    <p>Aprende a analizar evidencia y aplicar procedimientos investigativos con rigor técnico.</p>
                </div>
                <div class="program-competency-grid">
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="0">
                        ...
                        <div><h3>Análisis de evidencia</h3><p>Analiza evidencia con rigor técnico y metodológico.</p></div>
                    </div>
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="80">
                        ...
                        <div><h3>Procedimientos investigativos</h3><p>Aplica procedimientos investigativos en el esclarecimiento de hechos.</p></div>
                    </div>
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="160">
                        ...
                        <div><h3>Apoyo técnico forense</h3><p>Brinda apoyo técnico en procesos judiciales y forenses.</p></div>
                    </div>
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="240">
                        <span class="node"><svg viewBox="0 0 24 24"><use href="#ico-ai"/></svg></span>
                        <div><h3>Pensamiento analítico</h3><p>Desarrolla pensamiento analítico para la toma de decisiones.</p></div>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="section-inner">
                <article class="program-photo-panel" data-aos="fade-up">
                    ...
                    <div class="program-photo-panel-content">
                        ...
                        <p>Practica el análisis de evidencia y los procedimientos investigativos guiado por un equipo profesional.</p>
                    </div>
                </article>
            </div>
        </section>
        ...
        <section class="program-cta">
            ...
            <div class="section-inner program-cta-inner" data-aos="fade-up">
                <div>
                    <h2>¿Listo para formarte en Criminalística, Investigación Judicial y Ciencias Forenses?</h2>
