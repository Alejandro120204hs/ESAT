...
@section('title', 'Salud · Educación Continuada · ESAT')
@section('meta_description', 'Diplomados y cursos de Educación Continuada en Salud en ESAT: formación técnica certificada y práctica para instituciones del sector salud.')

@php
    // Drop the real photo in public/assets/img with this exact
    // filename and it replaces the placeholder panel automatically —
    // no code changes needed.
    $heroPhoto = 'salud-continuada.png';
    $heroPhotoExists = file_exists(public_path('assets/img/' . $heroPhoto));

    $courses = [
        'Registro y Auditoría en Servicios de Salud',
        ...
        'Secretariado Médico',
        'Radio Operador Tripulante de Ambulancia',
        'Salud Pública',
        'Gerontología',
    ];
@endphp
...
@section('content')
        ...
        <section class="program-hero">
            ...
            <div class="section-inner">
                <div class="program-hero-content">
                    ...
                    <h1>Salud</h1>
                    <p class="program-hero-tagline">Formación que salva vidas.</p>
                    <p class="program-hero-lead">Ofrecemos formación técnica certificada y práctica, enfocada en la atención segura, la prevención de riesgos y el fortalecimiento de competencias esenciales para desempeñarte con responsabilidad en instituciones del sector salud.</p>
                    <div class="hero-actions">
                        <a href="{{ $wa('Educación Continuada — Salud') }}" target="_blank" rel="noopener" class="btn btn-accent btn-lg">
        ...
        <section class="program-cta">
            ...
            <div class="section-inner program-cta-inner" data-aos="fade-up">
                <div>
                    <h2>¿Listo para formarte en Salud?</h2>
