...
@section('title', 'Salud Ocupacional · Educación Continuada · ESAT')
@section('meta_description', 'Diplomados y cursos de Educación Continuada en Salud Ocupacional en ESAT: prevención de riesgos, promoción del bienestar y cumplimiento normativo.')

@php
    // Drop the real photo in public/assets/img with this exact
    // filename and it replaces the placeholder panel automatically —
    // no code changes needed.
    $heroPhoto = 'salud-ocupacional-continuada.png';
    $heroPhotoExists = file_exists(public_path('assets/img/' . $heroPhoto));

    $courses = [
        'Salud Ocupacional con Énfasis en Seguridad Industrial',
        'Seguridad Industrial con Énfasis en Salud Ocupacional',
        'Seguridad y Salud en Obras de Construcción',
        'Primeros Auxilios para Conductores de Servicio Público',
        'Bioseguridad y Aseo Hospitalario',
    ];
@endphp
...
@section('content')
        ...
        <section class="program-hero">
            ...
            <div class="section-inner">
                <div class="program-hero-content">
                    ...
                    <p class="program-hero-tagline">Protege la vida en el entorno laboral.</p>
                    <p class="program-hero-lead">Formamos profesionales en prevención de riesgos, promoción del bienestar y cumplimiento normativo, para contribuir a entornos laborales seguros y productivos.</p>
                    <div class="hero-actions">
                        <a href="{{ $wa('Educación Continuada — Salud Ocupacional') }}" target="_blank" rel="noopener" class="btn btn-accent btn-lg">
        ...
        <section class="program-cta">
            ...
            <div class="section-inner program-cta-inner" data-aos="fade-up">
                <div>
                    <h2>¿Listo para formarte en Salud Ocupacional?</h2>
