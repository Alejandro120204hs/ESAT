...
@section('title', 'Asistente de Preescolar · ESAT — Formación Técnica Certificada')
@section('meta_description', 'Técnico en Asistente de Preescolar en ESAT: formación en apoyo educativo, cuidado infantil y acompañamiento pedagógico para la primera infancia.')
...
@section('content')
        ...
        <section class="program-hero">
            ...
            <div class="section-inner">
                <div class="program-hero-content">
                    ...
                    <h1>Asistente de Preescolar</h1>
                    <p class="program-hero-tagline">Acompañamiento con calidez en la primera infancia.</p>
                    <p class="program-hero-lead">Formamos profesionales en apoyo educativo, cuidado infantil y acompañamiento pedagógico, fortaleciendo el desarrollo integral, emocional y social de los niños en edad preescolar.</p>
                    <div class="hero-actions">
                        <a href="{{ $wa('Asistente de Preescolar') }}" target="_blank" rel="noopener" class="btn btn-accent btn-lg">
        ...
        <section class="program-section">
            ...
            <div class="section-inner">
                <div class="section-head" data-aos="fade-up">
                    ...
                    <p>Aprende a brindar apoyo educativo y acompañamiento pedagógico en la primera infancia.</p>
                </div>
                <div class="program-competency-grid">
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="0">
                        ...
                        <div><h3>Competencias pedagógicas</h3><p>Aplica estrategias pedagógicas para el aprendizaje infantil.</p></div>
                    </div>
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="80">
                        ...
                        <div><h3>Apoyo educativo</h3><p>Brinda apoyo educativo en el aula y en el aprendizaje diario.</p></div>
                    </div>
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="160">
                        ...
                        <div><h3>Cuidado y orientación infantil</h3><p>Acompaña el desarrollo emocional y social de los niños.</p></div>
                    </div>
            ...
            <div class="section-inner">
                <article class="program-photo-panel" data-aos="fade-up">
                    ...
                    <div class="program-photo-panel-content">
                        ...
                        <p>Practica el acompañamiento pedagógico y el cuidado infantil guiado por un equipo profesional.</p>
                    </div>
                </article>
            </div>
        </section>
        ...
        <section class="program-cta">
            ...
            <div class="section-inner program-cta-inner" data-aos="fade-up">
                <div>
                    <h2>¿Listo para formarte en Asistente de Preescolar?</h2>
