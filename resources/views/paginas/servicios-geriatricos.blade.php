            ...
            <div class="section-inner">
                ...
                <div class="program-competency-grid">
                    ...
                    <div class="program-competency-card" data-aos="fade-up" data-aos-delay="240">
                        ...
                        <div><h3>Mejora tu empleabilidad</h3><p>Un programa diseñado para prepararte mejor de cara al mercado laboral.</p></div>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="section-inner">
                <article class="program-photo-panel" data-aos="fade-up">
                    ...
                    <div class="program-photo-panel-content">
                        <h3>Aprende haciendo, desde el primer módulo</h3>
                        <p>Como en el resto de nuestros programas técnicos, la práctica es parte de la formación desde el inicio.</p>
                    </div>
                </article>
            </div>
        </section>
